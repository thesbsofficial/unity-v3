...
```javascript
cartItems.innerHTML =
  '<div class="cart-empty">Your basket is empty 🛒<br><small style="color: #999; font-size: 14px; margin-top: 10px; display: block;">Add some fire fits to get started! 🔥</small></div>';
```
